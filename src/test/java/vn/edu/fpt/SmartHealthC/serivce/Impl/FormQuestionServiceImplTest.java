...
public class FormQuestionServiceImplTest {
    ...
    void testCreateFormQuestion_Success() {
        ...
        requestDTO.setType(MonthlyRecordType.SAT_SF_C);
...
//
    ...
    void testGetFormQuestionById_Success() {
        ...
        FormQuestion formQuestion = FormQuestion.builder()
                ...
                .questionNumber(1)
                .type(MonthlyRecordType.SAT_SF_C)
                .build();
...
//
    ...
    void testGetAllFormQuestions_Success() {
        ...
        formQuestionList.add(FormQuestion.builder().id(1).question("Question 1").questionNumber(1).type(MonthlyRecordType.SAT_SF_C).build());
        formQuestionList.add(FormQuestion.builder().id(2).question("Question 2").questionNumber(2).type(MonthlyRecordType.SF_DIET).build());
...
//
    ...
    void testGetAllFormQuestionsMobile() {
        ...
        formQuestions.add(FormQuestion.builder().id(1).question("Question 1").questionNumber(1).type(MonthlyRecordType.SAT_SF_C).build());
        formQuestions.add(FormQuestion.builder().id(2).question("Question 2").questionNumber(2).type(MonthlyRecordType.SAT_SF_I).build());

        when(formQuestionRepository.findAll()).thenReturn(formQuestions);

        // Act
        List<FormQuestionResponseDTO> responseDTOS = formQuestionService.getAllFormQuestionsMobile(TypeLanguage.EN);
