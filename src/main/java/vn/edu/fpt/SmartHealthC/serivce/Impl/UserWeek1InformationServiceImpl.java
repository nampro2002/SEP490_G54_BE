...
public class UserWeek1InformationServiceImpl implements UserWeek1InformationService {
    ...
    @Override
    public UserWeek1Information getUserWeek1Information(Integer id) {
        Optional<UserWeek1Information> userWeek1Information = userWeek1InformationRepository.findById(id);
    ...
    public Lesson1DTO getLesson1(Integer id) {
        UserWeek1Information userWeek1Information = getUserWeek1Information(id);
