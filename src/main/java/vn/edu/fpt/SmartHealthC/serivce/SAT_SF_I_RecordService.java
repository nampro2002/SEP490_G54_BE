...
public interface SAT_SF_I_RecordService {
    ...
    Optional<SAT_SF_I_Record> getSAT_SF_I_RecordById(Integer id);
    List<SAT_SF_I_Record> getAllSAT_SF_I_Records();
    SAT_SF_I_Record updateSAT_SF_I_Record(SAT_SF_I_RecordDTO sat_sf_i_recordDTO);
    void deleteSAT_SF_I_Record(Integer id);
}