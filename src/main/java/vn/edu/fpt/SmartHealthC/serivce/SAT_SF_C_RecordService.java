...
public interface SAT_SF_C_RecordService {
    ...
    Optional<SAT_SF_C_Record> getSAT_SF_C_RecordById(Integer id);
    List<SAT_SF_C_Record> getAllSAT_SF_C_Records();
    SAT_SF_C_Record updateSAT_SF_C_Record(SAT_SF_C_RecordDTO sat_sf_c_recordDTO);
    void deleteSAT_SF_C_Record(Integer id);
}